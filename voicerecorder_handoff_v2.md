...
| 15 | Sentry webhook → automated bug fix loop | 7 | 7 | 4 | 196 | 🟡 Later — Sentry fires webhook on new issue → script formats error + breadcrumbs → triggers Claude Code CLI to diagnose and fix |
